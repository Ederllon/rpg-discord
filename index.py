...
subna1 = ['al','jam','ada','bal','bel','dan','don','dom','can','chru','pe','a','e','i','o','u','y','oto','shik','Thi','Thy','cha','pe','si','sil','sh','ko','no','ha','kyo','za','mu','yu','ri','yuri','yuta']
subna2 = ['al','jam','ada','bal','bel','dan','don','dom','can','chru','pe','','k','th','ph','oto','ha','cha','dro','si','sil','va','','','','','ko','sh','ap','ko','no','ha','maru','kyo','za','moth','mu','yu','ri','yuri','yuta']
subna3 = ['al','jam','ada','bal','bel','dan','don','dom','can','chru','pe','','','k','th','ph','a','e','i','o','u','y','te','maru','ha','cha','si','sil','','','ko','sh','ap','kyo','ko','no','ha','maru','za','moth','mu','yu','ri','yuri','yuta']
